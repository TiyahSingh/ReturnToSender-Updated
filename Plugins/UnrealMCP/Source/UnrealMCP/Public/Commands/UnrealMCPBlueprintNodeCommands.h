...
private:
    ...
    TSharedPtr<FJsonObject> HandleAddBlueprintComponentEvent(const TSharedPtr<FJsonObject>& Params);
    ...
    TSharedPtr<FJsonObject> HandleSetNodePinDefault(const TSharedPtr<FJsonObject>& Params);
    ...
    TSharedPtr<FJsonObject> HandleAddBlueprintMacro(const TSharedPtr<FJsonObject>& Params);
    TSharedPtr<FJsonObject> HandleAddBlueprintSpawnActorFromClass(const TSharedPtr<FJsonObject>& Params);
